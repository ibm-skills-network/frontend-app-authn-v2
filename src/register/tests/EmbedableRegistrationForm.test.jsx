...
const IntlEmbedableRegistrationForm = injectIntl(EmbedableRegistrationForm);
...
describe('RegistrationPage', () => {
  ...
  describe('Test Registration Page', () => {
    ...
    it('should update props with validations returned by registration api', () => {
      ...
      const registrationPage = mount(reduxWrapper(<IntlEmbedableRegistrationForm {...props} />)).find('EmbedableRegistrationForm');
